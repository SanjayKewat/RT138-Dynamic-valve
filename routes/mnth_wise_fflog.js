...
//Here to read data for Monthwise Function fail logs page
exports.mwise_fflog_clm = function(req, res,next){
    ...
    var opnQuery = "call mth_wse_opn_fflog("+rigid+","+vid+","+year+","+month+")";
    var clsQuery = "call mth_wse_cls_fflog("+rigid+","+vid+","+year+","+month+")";
...
exports.mwise_fflog_sct = function(req, res,next){
    ...
    var sqlQuery = "call mnth_wise_fflog_sct("+rigid+","+vid+","+year+","+month+")";
