...
//    var tm=req.param('to');
    ...
    var strQuery1 = " SELECT * FROM yr_opn_tot WHERE rig_id='"+rigid+"' AND yr ='"+year+"' order by valve_id";
    var strQuery2 = " SELECT * FROM yr_clos_tot WHERE rig_id='"+rigid+"' AND yr ='"+year+"' order by valve_id";
    var strQuery3 = " SELECT * FROM fmnth_opn_tot WHERE rig_id='"+rigid+"' AND yr ='"+year+"' order by valve_id";
    var strQuery4 = " SELECT * FROM fmnth_clos_tot WHERE rig_id='"+rigid+"' AND yr ='"+year+"' order by valve_id";
